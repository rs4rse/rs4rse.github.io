+++
title = "Mob (or vibe) coding small project to learn! (beginner friendly)"
date = 2026-01-29T16:30:00+01:30
+++

<center>
    <h2 class="subtitle"><strong>In person at PSI - OBBA-213</strong> <a href="https://maps.app.goo.gl/EkqANRqHfY1TLWNRA">(map)</a> </h2> <br>
...
In this session, we might:

- Look at how [GORBIE](https://github.com/triblespace/GORBIE) works - a minimalist notebook library for Rust. 
- Look at `phf`, `phf-codegen` its usage at `cif-chomper`.
- vibe code together on an open-source project from scratch: [vizmat](https://github.com/rs4rse/vizmat)
